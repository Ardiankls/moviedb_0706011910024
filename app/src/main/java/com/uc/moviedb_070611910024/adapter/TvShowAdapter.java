package com.uc.moviedb_070611910024.adapter;
...
import com.uc.moviedb_070611910024.ui.main.tvshow.TvShowFragmentDirections;
...
public class TvShowAdapter extends RecyclerView.Adapter<TvShowAdapter.CardViewViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final TvShowAdapter.CardViewViewHolder holder, int position) {
        ...
        Glide.with(context)
                .load(Constants.BASE_IMAGE_URL + tvShow.getCover())
                .into(holder.img);
